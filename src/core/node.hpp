...
public:
	...
	void renderInstanced(int instances_nb, glm::mat4 const& view_projection,
						 glm::mat4 const& parent_transform = glm::mat4(1.0f)) const;

	void renderInstanced(int instances_nb, glm::mat4 const& view_projection, glm::mat4 const& world,
						 GLuint program,
						 std::function<void(GLuint)> const& set_uniforms = [](GLuint /*programID*/) {}) const;
